...
import { FaBloggerB, FaFacebookF, FaLinkedinIn, FaPhone, FaWhatsapp, FaYoutube } from "react-icons/fa"
        ...
        <main>
            ...
            <section className="flex pr-24 pl-24 mt-28 mb-28 items-center">
                ...
                <section className=" mr-24 ml-24 bg-[#262729] rounded-xl text-white flex mb-20">
                    <div className="w-1/4">
                        <Image src="/imgContacto/img-contacto-form.png" alt="Contacta nuestros servicios" width={1000} height={1000} className="w-full h-full"/>
                    </div>
